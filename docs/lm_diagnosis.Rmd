...
ya que $\hat y = X \hat \beta = X (X^T X)^{-1} X^T y = H y$. Sustituyendo el valor de y:
...
ya que la matriz H es idempotente ($H H^T = I$). La varianza de cada residuo viene dada por:
