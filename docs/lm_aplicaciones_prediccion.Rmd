...
Recordamos que el modelo sería: kid_score ~ mom_iq + mom_hs_NO + mon_age + mom_work_2 + mom_work_3 + mom_work_4
...
Vamos a calcular el intervalo deconfianza utilizando bootstrap:
...
Vamos a calcular el intervalo de predicción utilizando bootstrap:

```{r}
yp_b = rep(0,B)
e = resid(m2)
# hacemos que los residuos tengan la varianza teorica (e/sR)*sqrt(sR2*(1+mat))
e1 = e * sqrt(1 + mat[1,1])
for (b in 1:B){
